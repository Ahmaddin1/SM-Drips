  ...
  return (
    <main className="min-h-screen bg-[#000000] text-[#E9E9E9]">
      <div ref={topSectionRef} className="py-20 px-6 text-center">
        <p className="text-xs tracking-[4px] uppercase text-[#aaa] mb-4 opacity-0">CONTACT US</p>
        <h1 className="text-4xl lg:text-5xl font-normal text-[#E9E9E9] mb-6 opacity-0">How can we help you?</h1>
        <p className="text-sm text-[#aaa] max-w-xl mx-auto leading-relaxed opacity-0">
          Need to get in touch? Reach out using the contact form below or send us a WhatsApp message directly. We're available Monday – Saturday, 10 AM – 8 PM PKT.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div ref={cardsRef} className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="flex flex-col items-center justify-center text-center py-14 px-8 gap-4 border border-[#282828] rounded-lg opacity-0">
            <Headphones size={28} strokeWidth={1.5} className="text-[#E9E9E9]" />
            <h2 className="text-base font-medium text-[#E9E9E9]">Order Status</h2>
            <a href={`https://wa.me/${waNumber}`} className="text-sm text-[#aaa] flex items-center gap-2">
              <Phone size={13} />
              {rawNumber}
            </a>
            <a href="mailto:contact@smdrips.com" className="text-sm text-[#aaa] flex items-center gap-2">
              <Mail size={13} />
              contact@smdrips.com
            </a>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center py-14 px-8 gap-4 border border-[#282828] rounded-lg opacity-0">
            ...
            <h2 className="text-base font-medium text-[#E9E9E9]">Start a Return</h2>
            <a href={`https://wa.me/${waNumber}`} className="text-sm text-[#aaa] flex items-center gap-2">
              <Phone size={13} />
              {rawNumber}
            </a>
          ...
          <div className="flex flex-col items-center justify-center text-center py-14 px-8 gap-4 border border-[#282828] rounded-lg opacity-0">
            ...
            <h2 className="text-base font-medium text-[#E9E9E9]">Sizing & Product Info</h2>
            <a href={`https://wa.me/${waNumber}`} className="text-sm text-[#aaa] flex items-center gap-2">
              <Phone size={13} />
              {rawNumber}
            </a>
      ...
      <div ref={formRef} className="max-w-2xl mx-auto px-6 py-16 flex flex-col gap-4">
        <input
          type="text"
        ...
        <button
          ...
          className="bg-[#defc3e] text-[#000000] text-sm font-semibold px-8 py-4 tracking-wide self-start rounded-lg hover:-translate-y-2.5 hover:shadow-2xl hover:shadow-[#DEFC3E] active:scale-90 transition-all opacity-0"
        >
          Send via WhatsApp
        </button>
        {sent && (
      ...
      <div className="border-t border-[#282828] py-10 flex flex-col items-center gap-5">
        <p className="text-[10px] tracking-[3px] uppercase text-[#555]">FOLLOW US</p>
